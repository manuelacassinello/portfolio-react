      ...
      <div className="bb">
        ...
        <div className="texti">
          ...
          <h1>The theme of this photographic novel is based on the reinterpretation of the chapter
            ...
            problems of the 21st century.</h1>

            <h2>The issues we chose are: war technologies, borders,
            ...
            <h3>The images displayed are selected from the whole 777 protoshoot.</h3>
          <h6>
            Colaborated with:
            Aina Viciano, Vinyet Tejedor and Clara Sameron.
          </h6>
