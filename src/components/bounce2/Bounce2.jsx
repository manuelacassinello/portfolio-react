...
export default function Bounce2() {
  return (
    <div className="bounce2" id="bounce2">
      <div className="bb">
          <div className="texti">

            <h1>This project we explore new ways of understanding and creating culture from an
              embodied perspective, to develop our
              understanding of culture to re-frame it and
              re-design it by taking self-experience as
              a starting point.</h1>
            ...
            <h6>
              Colaborated with:
              Aina Viciano, Carla
              Farré, Daba Solsona and Clara Sameron.
            </h6>
